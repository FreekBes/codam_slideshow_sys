...
<body onload="startSync('<?php echo $_GET['source']; ?>');">
	<main id="container">
		...
		<iframe class="media iframe" id="iframe" src="<?php echo $current_media; ?>" sandbox="allow-scripts" scrolling="no" style="display: none;">Could not load <?php echo $num; ?> (iframe)</iframe>
	</main>
</body>
