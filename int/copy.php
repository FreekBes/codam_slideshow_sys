<?php
	...
	// do not use php's copy, as it's easier to just use unix's (is recursive with -r)
	// $from_full and $to_full should be safe to use, as they're generated by this script and not by the user
