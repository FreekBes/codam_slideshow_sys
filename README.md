...
After that, run the following command to finish installation: `wget https://raw.githubusercontent.com/codam-coding-college/slideshow-system/main/utils/install.sh && sudo bash install.sh`.
