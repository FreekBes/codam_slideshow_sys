...
After that, run the following command to finish installation: `wget https://raw.githubusercontent.com/FreekBes/codam_slideshow_sys/main/utils/install.sh && sudo bash install.sh`.
